    ...
    class Program
    {
        static void Main(string[] args)
        {
			...
			//Part 2
			{
                ...
                foreach (var translator in translatorsDatabase)
                {
                    TranslatorManipulator.DecryptMessages(translator, 10);
                    TranslatorManipulator.MakeTranslatorSmart(translator);
                }

                foreach (var translator in translatorsDatabase)
                {
                    TranslatorManipulator.SetTranslatorToBroken(translator, "out of order");
                }
            }
        }
